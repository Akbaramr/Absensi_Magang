...
if (empty($_GET['tanggal_dari'])) {
    $result = mysqli_query($connection, "SELECT presensi.*, mahasiswa.nama, mahasiswa.lokasi_presensi FROM presensi JOIN mahasiswa ON presensi.id_mahasiswa = mahasiswa.id ORDER BY tanggal_masuk DESC");
} else {
    $tanggal_dari = $_GET['tanggal_dari'];
    $tanggal_sampai = $_GET['tanggal_sampai'];
    $result = mysqli_query($connection, "SELECT presensi.*, mahasiswa.nama, mahasiswa.lokasi_presensi FROM presensi JOIN mahasiswa ON presensi.id_mahasiswa = mahasiswa.id WHERE tanggal_masuk BETWEEN '$tanggal_dari' AND '$tanggal_sampai' ORDER BY tanggal_masuk DESC");
}
